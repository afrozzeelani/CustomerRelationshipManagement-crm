...
class Employee extends Component {
  ...
  // handleEmployeeSubmit = async (event) => {
  //   event.preventDefault();
  ...
  //   formData.append('Gender', this.state.addFormGender);
  ...
  //       // Add any further handling, such as updating the UI or redirecting to another page
  //       this.setState({ table: true });
  //     }
  //   } catch (error) {
