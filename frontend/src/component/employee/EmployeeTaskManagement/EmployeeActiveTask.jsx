        ...
        {tasks
          ...
          .map((task, index) => (
            <details
              ...
              key={task.id}
            >
              <summary style={{height:'fit-content'}} className="d-flex justify-content-between aline-center form-control bg-danger ">
              ...
              >
                <div style={{height:'fit-content'}} className="form-control">
                  ...
                  <div style={{height:'fit-content'}} className="row form-control d-flex my-1 pt-3 rounded mx-1 justify-content-between">
