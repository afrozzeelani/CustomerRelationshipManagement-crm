...
class EmployeeFormEdit extends Component {
  ...
  render() {
    return (
      <React.Fragment style={{ height: '100vh', width: '100%' }} className="registration-page py-4">
        <h2 id="role-form-title" className="text-center text-black text-uppercase fw-bold my-4" >Edit Employee Details</h2>
