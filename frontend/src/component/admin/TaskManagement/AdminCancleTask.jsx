...
const AdminCancleTask = () => {
  ...
  useEffect(() => {
    const fetchDataWithTimeout = async () => {
      try {
        ...
        timeoutRef.current = setTimeout(fetchDataWithTimeout, 60000);
      }
    };
  ...
  return (
    <div className="py-2">
      <h1 className="fs-3 fw-bolder text-uppercase px-2 ">Cancelled Task</h1>
      {loading && (
        <div
        ...
        {tasks
          ...
          >
            ...
            >
              ...
              >
                <h1 className="text-uppercase text-light fw-bolder">c a n c e l l e d</h1>
              </div>
              ...
              className="row p-1 my-2 mx-0 bg-light text-dark rounded"
            >
              <div style={{width:'99.4%', height:'100%' , zIndex:'5', backgroundColor:'rgba(128, 128, 128, 0.422)' , textShadow:'-5px 5px 5px rgba(128, 128, 128, 0.422)' }} className="watermark form-control   position-absolute d-flex justify-content-center aline-center">
                <h1 className="text-uppercase text-light fw-bolder">c a n c e l l e d</h1>
              </div>
              <div style={{height:'fit-content'}} className="form-control">
