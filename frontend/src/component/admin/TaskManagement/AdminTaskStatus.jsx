...
const AdminTaskStatus = () => {
  ...
  return (
    <div className="py-2">
      <h1 className="fs-3 fw-bolder text-uppercase px-2">Active Task Status</h1>
      <div
        style={{
          overflowY: "scroll",
          height: "80vh",
      ...
      >
        {tasks
          ...
          >
            <summary style={{ color:"black", height:'fit-content'}} className="d-flex justify-content-between aline-center form-control bg-black text-white">
              ...
              <div className="d-flex gap-2 RemainingTimeHandel justify-content-between ">
                ...
                {calculateRemainingTime(task.endDate).delay ? (
                  ...
                  <div className="text-center">
                    <div
                      style={{ boxShadow: "0 0 5px 2px gray inset", color:"black" }}
                      className="form-control fw-bold px-1 py-0"
                    >
                      {calculateRemainingTime(task.endDate).hours}{" "}
                    </div>{" "}
