...
const AdminCompleteTask = () => {
  ...
  return (
    <div className="py-2">
      <h1 className="fs-3 fw-bolder text-uppercase px-2  ">Completed Tasks</h1>
      {loading && (
        <div
      ...
      >
        {tasks
          ...
          >
            ...
            >
              <div style={{width:'99.4%', height:'100%' , zIndex:'5', backgroundColor:'rgba(0, 128, 0, 0.384)', textShadow:'-5px 5px 5px rgba(128, 128, 128, 0.422)' }} className="watermark form-control   position-absolute d-flex justify-content-center aline-center">
                <h1 className="text-uppercase text-light fw-bolder">C O M P L E T E D</h1>
              </div>
